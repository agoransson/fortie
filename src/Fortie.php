...
use Wetcat\Fortie\Transports\ITransport;
use ReflectionClass;
...
{
    /**
     * Storage for Fortie transport client implementation.
     */
    ...
    public function __construct(
        ...
        $refClass = new ReflectionClass($transport);
        $this->transport = $refClass->newInstanceArgs($args);
    }
